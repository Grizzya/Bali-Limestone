      ...
      <div
        ...
        <button
          ...
          className="absolute top-4 right-4 md:top-5 md:right-5 flex items-center justify-center z-20 transition-all
                     ...
                     md:w-10 md:h-10 md:bg-white/80 md:hover:bg-white md:rounded-full md:text-gray-600 md:hover:text-black md:shadow"
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7 md:w-6 md:h-6">
