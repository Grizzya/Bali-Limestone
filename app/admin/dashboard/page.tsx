...
export default async function DashboardHomePage() {
  // Mengambil total jumlah data dari semua tabel secara bersamaan
    ...
    <div className="p-8 max-w-6xl mx-auto text-black">
      ...
      <div className="mt-10 bg-white p-8 rounded-xl border border-gray-100 shadow-sm">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Link href="/admin/dashboard/jasa" className="px-6 py-3 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-all">
            + Tambah Jasa
          </Link>
