...
export default async function TestimoniPage() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto text-black">
      <h1 className="text-3xl font-bold mb-8 text-gray-800">Kelola Testimoni Pelanggan</h1>
      
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* FORM TAMBAH */}
        <div className="lg:col-span-1 bg-white rounded-xl shadow-sm border border-gray-100 p-6 h-fit">
          <h2 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-2">Tambah Testimoni</h2>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 h-full">
            <div className="p-6 border-b border-gray-100 bg-gray-50 flex justify-between items-center rounded-t-xl">
              <h2 className="text-xl font-semibold text-gray-800">Daftar Testimoni</h2>
            </div>
            <div className="overflow-x-auto p-4">
              <div className="flex flex-col gap-4">
                ...
                {daftarTestimoni.length === 0 && <p className="text-center text-gray-500 p-4">Belum ada testimoni tersimpan.</p>}
              </div>
            </div>
          </div>
        </div>
