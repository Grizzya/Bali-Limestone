...
import PasswordField from '../components/PasswordField'; // Import komponen baru
    ...
    <div className="p-8 max-w-2xl mx-auto text-black">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        <form action={tambahAdmin} className="flex flex-col gap-5">
          {/* ... (Input Nama, Username, dan Email biarkan sama seperti sebelumnya) ... */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap</label>
            <input type="text" name="nama" required placeholder="Masukkan nama asli" className="w-full border px-4 py-3 rounded-lg outline-none" />
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Username</label>
            <input type="text" name="username" required placeholder="Contoh: govinda_dev" className="w-full border px-4 py-3 rounded-lg outline-none" />
          </div>
          ...
          <div>
            ...
            {/* GUNAKAN KOMPONEN PASSWORD DI SINI */}
          ...
          <div>
            ...
            <select name="role" className="w-full border px-4 py-3 rounded-lg outline-none bg-white">
              <option value="ADMIN">ADMIN (Kelola Konten Katalog)</option>
              <option value="SUPERADMIN">SUPERADMIN (Konten + Kelola Struktur Tim)</option>
            </select>
          </div>
