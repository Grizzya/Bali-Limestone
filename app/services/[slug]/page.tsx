      ...
      <section className="bg-white pt-28 lg:pt-40 pb-16 lg:pb-20">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            {/* CTA Kuning */}
            <div className="lg:col-span-4 self-start lg:mt-14">
              <div className="bg-[#ffcc00] rounded-xl p-8 lg:p-23 flex flex-col items-center justify-center text-center shadow-sm">
                ...
                <a
                  ...
                  className="w-full lg:w-[320px] bg-[#2A2A2A] hover:bg-black transition-colors text-white py-4 rounded-lg flex justify-center items-center shadow-md hover:scale-105 duration-300"
                >
